...
namespace DataStructuresCSharpTest.Collections.RedBlackTree
{
    ...
    public class RedBlackTreeTestsStrinString : RedBlackTreeTests<string, string>
    {
    ...
    public class RedBlackTreeTestsIntInt : RedBlackTreeTests<int, int>
    {
    ...
    public class RedBlackTreeTestsSimpleIntIntWithComparerWrapStructuralSimpleInt : RedBlackTreeTests<SimpleInt, int>
    {
        protected override bool DefaultValueAllowed => true;
