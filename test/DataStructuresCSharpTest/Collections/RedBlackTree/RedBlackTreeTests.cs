...
namespace DataStructuresCSharpTest.Collections.RedBlackTree
{
    public abstract class RedBlackTreeTests<TKey, TValue> : IDictionaryGenericTests<TKey, TValue>
    {
        ...
        public void Generic_Constructor_IDictionary_IComparer(int count)
        {
            ...
            var source = GenericIDictionaryFactory(count);
            var copied = new RedBlackTree<TKey, TValue>(source, comparer);
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void RedBlackTree_Generic_ContainsValue_NotPresent(int count)
        {
            var dictionary = (RedBlackTree<TKey, TValue>)GenericIDictionaryFactory(count);
            var seed = 4315;
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void RedBlackTree_Generic_ContainsValue_Present(int count)
        {
            var dictionary = (RedBlackTree<TKey, TValue>)GenericIDictionaryFactory(count);
            var seed = 4315;
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void RedBlackTree_Generic_ContainsValue_DefaultValueNotPresent(int count)
        {
            var dictionary = (RedBlackTree<TKey, TValue>)GenericIDictionaryFactory(count);
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void RedBlackTree_Generic_ContainsValue_DefaultValuePresent(int count)
        {
            var dictionary = (RedBlackTree<TKey, TValue>)GenericIDictionaryFactory(count);
            var seed = 4315;
