...
{
    public class RedBlackTreeTestsValues : ICollectionGenericTests<string>
    {
        ...
        {
            return new RedBlackTree<string, string>().Values;
        }

        protected override ICollection<string> GenericICollectionFactory(int count)
        {
            var list = new RedBlackTree<string, string>();
            var seed = 13453;
        ...
        {
            var dictionary = new RedBlackTree<string, string>();
            var seed = 13453;
