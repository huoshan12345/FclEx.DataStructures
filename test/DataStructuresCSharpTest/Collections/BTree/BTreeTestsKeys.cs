...
{
    public class BTreeTestsKeys : ICollectionGenericTests<string>
    {
        ...
        protected override ICollection<string> GenericICollectionFactory() => new BTree<string, string>().Keys;
