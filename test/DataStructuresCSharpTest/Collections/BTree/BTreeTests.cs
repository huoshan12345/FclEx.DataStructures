...
{
    public abstract class BTreeTests<TKey, TValue> : IDictionaryGenericTests<TKey, TValue>
    {
        #region IDictionary<TKey, TValue Helper Methods

        protected override bool EnumeratorCurrentUndefinedOperationThrows => true;

        protected override IDictionary<TKey, TValue> GenericIDictionaryFactory() => new BTree<TKey, TValue>();
        ...
        public void BTree_Generic_Constructor_IDictionary(int count)
        {
            var source = GenericIDictionaryFactory(count);
            IDictionary<TKey, TValue> copied = new BTree<TKey, TValue>(source);
            Assert.Equal(source.Count, copied.Count);
        }

        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void BTree_Generic_Constructor_IDictionary_IComparer(int count)
        {
            var comparer = GetKeyIComparer();
            var source = GenericIDictionaryFactory(count);
            var copied = new BTree<TKey, TValue>(source, comparer);
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void BTree_Generic_Constructor_IComparer(int count)
        {
            var comparer = GetKeyIComparer();
            var source = GenericIDictionaryFactory(count);
            var copied = new BTree<TKey, TValue>(source, comparer);
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void BTree_Generic_ContainsValue_NotPresent(int count)
        {
            var dictionary = (BTree<TKey, TValue>)GenericIDictionaryFactory(count);
            var seed = 4315;
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void BTree_Generic_ContainsValue_Present(int count)
        {
            var dictionary = (BTree<TKey, TValue>)GenericIDictionaryFactory(count);
            var seed = 4315;
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void BTree_Generic_ContainsValue_DefaultValueNotPresent(int count)
        {
            var dictionary = (BTree<TKey, TValue>)GenericIDictionaryFactory(count);
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void BTree_Generic_ContainsValue_DefaultValuePresent(int count)
        {
            var dictionary = (BTree<TKey, TValue>)GenericIDictionaryFactory(count);
            var seed = 4315;
