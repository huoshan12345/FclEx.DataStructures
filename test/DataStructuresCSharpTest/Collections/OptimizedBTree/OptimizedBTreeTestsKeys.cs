...
{
    public class OptimizedBTreeTestsKeys : ICollectionGenericTests<string>
    {
        ...
        protected override ICollection<string> GenericICollectionFactory() => new OptimizedBTree<string, string>().Keys;
