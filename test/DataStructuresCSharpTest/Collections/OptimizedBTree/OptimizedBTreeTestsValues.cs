...
{
    public class OptimizedBTreeTestsValues : ICollectionGenericTests<string>
    {
        ...
        protected override ICollection<string> GenericICollectionFactory() => new OptimizedBTree<string, string>().Values;
