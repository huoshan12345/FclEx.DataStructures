...
namespace DataStructuresCSharpTest.Collections.OptimizedBTree
{
    ...
    public class OptimizedBTreeTestsStrinString : OptimizedBTreeTests<string, string>
    {
    ...
    public class OptimizedBTreeTestsIntInt : OptimizedBTreeTests<int, int>
    {
    ...
    public class OptimizedBTreeTestsSimpleIntIntWithComparerWrapStructuralSimpleInt : OptimizedBTreeTests<SimpleInt, int>
    {
        protected override bool DefaultValueAllowed => true;
