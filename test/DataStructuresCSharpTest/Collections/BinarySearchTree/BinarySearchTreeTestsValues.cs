...
{
    public class BinarySearchTreeTestsValues : ICollectionGenericTests<string>
    {
        ...
        {
            return new BinarySearchTree<string, string>().Values;
        }

        protected override ICollection<string> GenericICollectionFactory(int count)
        {
            var list = new BinarySearchTree<string, string>();
            var seed = 13453;
        ...
        {
            var dictionary = new BinarySearchTree<string, string>();
            var seed = 13453;
