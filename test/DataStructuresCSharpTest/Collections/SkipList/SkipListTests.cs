...
{
    public abstract class SkipListTests<TKey, TValue> : IDictionaryGenericTests<TKey, TValue>
    {
        ...
        public void SkipList_Generic_Constructor_IDictionary(int count)
        {
            var source = GenericIDictionaryFactory(count);
            IDictionary<TKey, TValue> copied = new SkipList<TKey, TValue>(source);
            Assert.Equal(source.Count, copied.Count);
        }

        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void SkipList_Generic_Constructor_IDictionary_IComparer(int count)
        {
            var comparer = GetKeyIComparer();
            var source = GenericIDictionaryFactory(count);
            var copied = new SkipList<TKey, TValue>(source, comparer);
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void SkipList_Generic_Constructor_IComparer(int count)
        {
            var comparer = GetKeyIComparer();
            var source = GenericIDictionaryFactory(count);
            var copied = new SkipList<TKey, TValue>(source, comparer);
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void SkipList_Generic_ContainsValue_NotPresent(int count)
        {
            var dictionary = (SkipList<TKey, TValue>)GenericIDictionaryFactory(count);
            var seed = 4315;
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void SkipList_Generic_ContainsValue_Present(int count)
        {
            var dictionary = (SkipList<TKey, TValue>)GenericIDictionaryFactory(count);
            var seed = 4315;
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void SkipList_Generic_ContainsValue_DefaultValueNotPresent(int count)
        {
            var dictionary = (SkipList<TKey, TValue>)GenericIDictionaryFactory(count);
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void SkipList_Generic_ContainsValue_DefaultValuePresent(int count)
        {
            var dictionary = (SkipList<TKey, TValue>)GenericIDictionaryFactory(count);
            var seed = 4315;
