...
{
    public class TwoFourTreeValues : ICollectionGenericTests<string>
    {
        ...
        protected override ICollection<string> GenericICollectionFactory() => new TwoFourTree<string, string>().Values;
