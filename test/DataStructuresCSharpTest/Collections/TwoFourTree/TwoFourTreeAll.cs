...
{
    public class TwoFourTreeTestsStrinString : TwoFourTreeTests<string, string>
    {
    ...
    public class TwoFourTreeTestsIntInt : TwoFourTreeTests<int, int>
    {
    ...
    public class TwoFourTreeTestsSimpleIntIntWithComparerWrapStructuralSimpleInt : TwoFourTreeTests<SimpleInt, int>
    {
        protected override bool DefaultValueAllowed => true;
