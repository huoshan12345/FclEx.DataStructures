...
{
    public abstract class BPlusTreeTests<TKey, TValue> : IDictionaryGenericTests<TKey, TValue>
    {
        #region IDictionary<TKey, TValue Helper Methods

        protected override bool EnumeratorCurrentUndefinedOperationThrows => true;

        protected override IDictionary<TKey, TValue> GenericIDictionaryFactory() => new BPlusTree<TKey, TValue>();
        ...
        public void BPlusTree_Generic_Constructor_IDictionary_IComparer(int count)
        {
            ...
            var source = GenericIDictionaryFactory(count);
            var copied = new BPlusTree<TKey, TValue>(source, comparer);
