...
{
    public class BPlusTreeTestsValues : ICollectionGenericTests<string>
    {
        ...
        protected override ICollection<string> GenericICollectionFactory() => new BPlusTree<string, string>().Values;

        protected override ICollection<string> GenericICollectionFactory(int count)
        {
            var list = new BPlusTree<string, string>();
            var seed = 13453;
        ...
        {
            var dictionary = new BPlusTree<string, string>();
            var seed = 13453;
