...
{
    public class BPlusTreeTestsKeys : ICollectionGenericTests<string>
    {
        ...
        protected override ICollection<string> GenericICollectionFactory() => new BPlusTree<string, string>().Keys;
